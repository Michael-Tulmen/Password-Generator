This application is a random password generator that prompts the user for different data types before creating a randomized secure password for information security.
